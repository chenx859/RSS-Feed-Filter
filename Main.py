# 6.00.1x Problem Set 7 adapted by Ryan Chen
# RSS Feed Filter
...
def readTriggerConfig(filename):
    ...
    """
    # Code to read in the file and eliminate
...
def main_thread(master):
    try:
        # Pull triggers from the .txt file
        ...
        cont = Text(master, font=("Helvetica",14), yscrollcommand=scrollbar.set,bg="blue",fg="white")
...
if __name__ == '__main__':
    ...
    root = Tk()
    root.title("RSS Google & Yahoo Top News Filter")
